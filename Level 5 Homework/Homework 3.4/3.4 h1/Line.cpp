...
namespace AndrewGuerrand
{
    namespace CAD
    {
            ...
            Line::Line(): p_starting(0.0,0.0), p_ending(0.0,0.0)            //Default constructor, and list initialization method as seen further in Lecture 3-04
            {
                //p_starting = Point(0.0, 0.0);
                //p_ending = Point(0.0, 0.0);
            ...
            Line::Line(const Line &source): p_starting(source.p_starting), p_ending(source.p_ending)        //Copy constructor of referenced line
            {
