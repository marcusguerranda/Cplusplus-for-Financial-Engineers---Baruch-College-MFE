...
namespace AndrewGuerrand
{
    namespace Containers
    {
        ...
        Array::Array(const int &given_size): m_size(given_size), m_data(new CAD::Point[m_size])          //Constructor with size argument, taking const reference
        {
            m_size = given_size;                                                                    
        ...
        void Array::SetElement(const CAD::Point& p, int index)                      //Functions that sets an element. When the index is ount of bounds, ignore the "set"
