...
namespace AndrewGuerrand
{
	namespace CAD
	{
			...
			Point::Point():m_x(0.0), m_y(0.0)	//Default constructor, and list initialization method as seen further in Lecture 3-04
			{
			}
			...
			Point::Point(double testvalue): m_x(testvalue), m_y(testvalue)			//Constructor for a Point object taking one double value, and giving this value to both x and y coordinates
			{																		//This constructor has been declared as explicit.
			}
			...
			{
				os << p.ToString(); 												//Sending to os stream
				return os;
			}
	}		
